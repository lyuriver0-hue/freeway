...
const FREEWAY_COMMUNITY_POSTS = [
  {id:'c1', cat:'꿀팁공유', title:'프리랜서 첫 견적서 작성할 때 꿀팁 공유합니다', author:'디자이너K', date:'2026-07-03', views:412, comments:12},
  {id:'c2', cat:'질문답변', title:'안전결제 정산까지 보통 며칠 걸리나요?', author:'초보의뢰인', date:'2026-07-02', views:203, comments:5},
  {id:'c3', cat:'공지', title:'커뮤니티 이용 가이드라인 안내', author:'프리웨이팀', date:'2026-06-28', views:891, comments:1},
  {id:'c4', cat:'질문답변', title:'표준계약서 특약사항 추가하고 싶은데 가능한가요?', author:'스타트업대표', date:'2026-06-25', views:156, comments:8},
];
